...
public static class ILRuntimeCLRBinding
{
    ...
    static void GenerateCLRBinding()
    {
        ...
        ILRuntime.Runtime.CLRBinding.BindingCodeGenerator.GenerateBindingCode(types, "Assets/ModelView/ILRuntime/ILBinding");
		AssetDatabase.Refresh();
        Debug.Log("Generate Done!");
    }

    //自动分析Hotfix.dll添加类型 绑定
    ...
    static void GenerateCLRBindingByAnalysis()
    {
        ...
        using (FileStream fs = new FileStream("Assets/Res/Code/Hotfix.dll.bytes", FileMode.Open, FileAccess.Read))
        {
	        ...
	        ILRuntime.Runtime.CLRBinding.BindingCodeGenerator.GenerateBindingCode(domain, "Assets/ModelView/ILRuntime/ILBinding");
	        AssetDatabase.Refresh();
        }
        Debug.Log("Analysis Generate Done!");
    }
}
#endif
